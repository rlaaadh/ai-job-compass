...
def build_company_prompt(score: HealthScoreResult, company_name: str) -> str:
    ...
    payload = {
        ...
        "세부점수": {
            ...
            "기업규모(0-10, 직원 수와 규모 변화 흐름 기준)": score.size_fit,
            "연봉추정신호(0-10, 직무·연차 평균 비교 아님)": score.salary_signal,
    ...
    return (
        ...
        "성장성, 안정성, 채용활동성 멘트는 점수 구간별로 온도를 다르게 표현하세요. "
        "예를 들어 낮은 점수는 조심스럽지만 위트 있게, 높은 점수는 기대감을 주는 방식이 좋습니다. "
        "채용활동성은 최근 확보된 월별 국민연금 데이터 기준 해석임을 드러내고, "
        "점수가 낮으면 최근 적극적으로 채용 중이라고 보기 어렵다는 뜻이 전달되게 쓰세요.\n\n"
        "{\n"
